package com.proyecto.quedemos.Caldroid;
...
public class CaldroidCustomAdapter extends CaldroidGridAdapter  {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView dia = (TextView) cellView.findViewById(R.id.dia);
        TextView eventos = (TextView) cellView.findViewById(R.id.eventos);
        ...
        if ((minDateTime != null && dateTime.lt(minDateTime))
            ...
            dia.setTextColor(CaldroidFragment.disabledTextColor);
        ...
        setCustomResources(dateTime, cellView, dia);
