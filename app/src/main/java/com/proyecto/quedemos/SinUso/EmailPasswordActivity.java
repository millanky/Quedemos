...
import com.proyecto.quedemos.InicioSesion.BaseActivity;
...
public class EmailPasswordActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        emailPasswordFields = (LinearLayout) findViewById(R.id.email_password_fields);
        emailPasswordButtons = (LinearLayout) findViewById(R.id.email_password_buttons);
